        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {caseStudies.map((study, index) => (
            ...
            >
              ...
              <p className="text-sm text-slate-600 mb-3">{study.client}</p>
        ...
        <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl overflow-hidden">
          ...
          <div className="bg-white p-8 border-b">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-slate-600">{selectedCase.industry}</span>
            </div>
          ...
          <div className="p-8">
            ...
            {/* Results */}
            <div className="bg-gradient-to-br from-blue-500 to-green-500 rounded-2xl p-8 text-white mb-8">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-white rounded-xl">
                ...
                <div className="font-bold text-slate-800">{selectedCase.engagement.duration}</div>
              </div>
              <div className="text-center p-4 bg-white rounded-xl">
                <div className="text-sm text-slate-500 mb-1">Team Size</div>
                <div className="font-bold text-slate-800">{selectedCase.engagement.teamSize}</div>
              </div>
              <div className="text-center p-4 bg-white rounded-xl">
                <div className="text-sm text-slate-500 mb-1">Partnership Status</div>
                <div className="font-bold text-green-600">{selectedCase.engagement.ongoing}</div>
              </div>
            </div>

            {/* Technologies */}
            <div className="mt-6 text-center">
              <div className="text-sm text-slate-500 mb-3">Technologies Used</div>
